...
public class UserControllerTest {
	...
	public void getAUserTest() {
		...
		assertEquals(Constants.MOCK_USER_OBJECT, controller.getAUser(1));
	}
	...
	public void deleteUserTest() {
		...
		assertEquals(Constants.MOCK_USER_OBJECT, controller.deleteUser(1));
	...
	public void updateUserDetailsTest() {
		...
		assertEquals(Constants.MOCK_USER_OBJECT, controller.updateUserDetails(1, userString));
	...
	public void addFavouriteFilmTest() {
		...
		assertEquals(Constants.MOCK_USER_OBJECT, controller.addFavouriteFilm(1, 2));
	...
	public void deleteFavouriteFilmTest() {
		...
		assertEquals(Constants.MOCK_USER_OBJECT, controller.deleteFavouriteFilm(1, 2));
